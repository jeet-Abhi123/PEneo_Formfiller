...
class SIBRDataset(Dataset):
    ...
    ENTITY_LABEL_LIST = ["widget", "text", "list-item", "section-header", "legend", "table-header"]
    LABEL_LIST = [
        "B-widget",
        "I-widget",
        "B-text",
        ...
        **kwargs,
        ...
        with open(dir_split_file, "r") as f:
            ...
            annotation_fname_list = [
                ...
                if x.strip()  # Filter out empty lines
            ]
    ...
    def __getitem__(self, index):
        ...
        for sorted_line_idx, ln in enumerate(all_sorted_line_list):
            ...
            # Include all entity types in line extraction (widget, text, list-item, legend, section-header, table-header)
            if line_class_str in ["widget", "text", "list-item", "legend", "section-header", "table-header"]:
        ...
        for kv_entity_info in document_info["relations"]["kv_entity"]:
            ...
            # T2T relation (independent - NOT nested!)
